...
# def choose_best_attribute(X, y, used_attributes):
#     best_gain = 0
#     best_attribute = None
#     best_threshold = None
...
# def create_decision_tree(X, y, used_attributes=None):
#     if len(set(y)) == 1:
...
#     best_attribute, best_threshold = choose_best_attribute(X, y, used_attributes)
...
#             else:
#                 node.add_child(value, create_decision_tree(subset_X, subset_y, used_attributes.copy()))
#     else:
